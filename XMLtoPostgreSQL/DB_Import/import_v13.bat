...
set schema_name=project_database_v13_imp
...
IF exist XML_Dokumente\locale_*.xml (
	for %%f in (XML_Dokumente\locale_*.xml) do (
		if !exitcode1!==1 (
			java  -cp ../Validierung/ ValidateXML ../XSD/OpenInfRA_xsd_v13.xsd %%f
...
IF exist XML_Dokumente\value_lists.xml (
	java  -cp ../Validierung/ ValidateXML ../XSD/OpenInfRA_xsd_v13.xsd XML_Dokumente\value_lists.xml 
	set exitcode2=!ERRORLEVEL!
)ELSE (
	echo Wertelisten sind nicht im Ordner XML_Dokumente enthalten. 
)
echo.
IF exist XML_Dokumente\v13\OpenInfRA_XML.xml (
	java  -cp ../Validierung/ ValidateXML ../XSD/OpenInfRA_xsd_v13.xsd XML_Dokumente\v13\OpenInfRA_XML.xml 
...
if !exitcode1!==1 (
	if !exitcode2!==1 (
		if !exitcode3!==1 (
			java -cp ..\XML_Export_automatisiert\saxonb9\saxon9.jar net.sf.saxon.Transform -s:XML_Dokumente\v13\OpenInfRA_XML.xml -xsl:XSLT\import_instanz_v13.xslt spath=%schema_name%
