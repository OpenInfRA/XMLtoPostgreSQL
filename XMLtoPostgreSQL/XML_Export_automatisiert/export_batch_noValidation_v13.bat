...
IF exist Datenbank_Exportdatei\DB_Export.xml (
	...
	echo.
	java -cp Saxon\saxon9he.jar net.sf.saxon.Transform -s:Datenbank_Exportdatei\DB_Export.xml -xsl:XSLT\trafo_Instanzdokument_v13.xslt
	IF exist Ergebnis_XML\v13\OpenInfRA_XML.xml (
